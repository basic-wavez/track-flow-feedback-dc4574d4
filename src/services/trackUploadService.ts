...
export const createTrackVersion = async (
  ...
  try {
    console.log("trackUploadService - Creating new version of track:", originalTrackId);
    ...
    console.log("trackUploadService - Root parent track ID:", rootParentId);
    ...
    if (familyError) {
      console.error("trackUploadService - Error fetching version family:", familyError);
    }
    ...
    console.log("trackUploadService - Using new version number:", newVersionNumber);
    
    // Mark ALL tracks in this version family as not latest version
    if (rootParentId) {
      console.log("trackUploadService - Updating is_latest_version flag for all family tracks");
